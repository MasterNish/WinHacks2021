...
def p1pick2():
    ...
    screen.blit(myPicList[6], LeBron_JamesPick)
    screen.blit(myPicList[7], Kawhi_LeonardPick)
    screen.blit(myPicList[8], Stephen_CurryPick)
    screen.blit(myPicList[9], Nikola_JokicPick)
    screen.blit(myPicList[10], GiannisPick)
    screen.blit(myPicList[11], Kevin_DurantPick)
